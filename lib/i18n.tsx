...
const en: Dict = {
  ...
  join: {
    ...
    subtitle: "You've been invited to join a shared household",
    prompt: 'Click below to accept the invitation and share finances with your household.',
    accept: 'Accept Invitation',
    joining: 'Joining...',
    success: "You've joined {name}! Redirecting...",
    skip: 'Skip for now',
    invalidLink: 'Invalid or missing invitation link.',
    loginFirst: 'Sign in to continue',
    loginFirstSub: 'You need to sign in or create an account before joining a household.',
    error: 'An error occurred. Please try again.',
  },
  dashboard: {
    title: 'Dashboard',
    ...
    monthlyTrendSub: 'Income vs expenses over time',
    topMerchants: 'Top Merchants',
    topMerchantsSub: 'Highest spending by merchant',
    categoryBreakdown: 'Category Breakdown',
    merchantBreakdown: 'Merchant Breakdown',
    merchantBreakdownSub: 'Spending distribution by merchant',
    creditCards: 'Credit Cards',
    transactions: 'transactions',
    categoryTrend: 'Category Trends',
    categoryTrendSub: 'Top categories month over month',
  },
  upload: {
    ...
    tabUpload: 'Upload',
    tabArchive: 'File Archive',
    archiveTitle: 'Uploaded Files',
    archiveSub: 'View, download, or remove your uploaded files',
    archiveEmpty: 'No files uploaded yet',
    archiveFile: 'File',
    archiveDate: 'Upload Date',
    archiveRows: 'Rows',
    archiveSource: 'Source',
    archiveSize: 'Size',
    archiveDownload: 'Download',
    archiveDelete: 'Delete',
    archiveConfirm: 'Delete this file and all its transactions?',
    archiveDeleted: 'File deleted successfully',
    archiveNoFile: 'No original file',
  },
  sources: {
    bank: 'Bank',
    bit: 'Bit',
  ...
  settings: {
    ...
    devInviteNote: 'Dev mode: Share this link with the invited user',
...
const he: Dict = {
  ...
  signup: {
    ...
    passwordNoUppercase: 'הסיסמה חייבת להכיל אות גדולה',
    passwordNoLowercase: 'הסיסמה חייבת להכיל אות קטנה',
    passwordNoNumber: 'הסיסמה חייבת להכיל מספר',
    req8chars: '8+ תווים',
    reqUppercase: 'אות גדולה',
    reqLowercase: 'אות קטנה',
    reqNumber: 'מספר',
  },
  forgotPassword: {
    title: 'שכחתי סיסמה',
    subtitle: 'הזן את האימייל שלך לאיפוס הסיסמה',
    email: 'כתובת אימייל',
    send: 'שלח קישור איפוס',
    sending: 'שולח...',
    sent: 'אם קיים חשבון עם אימייל זה, קישור איפוס נשלח.',
    backToLogin: 'חזרה להתחברות',
    error: 'אירעה שגיאה. נסה שוב.',
    devNote: 'מצב פיתוח: לחץ על הקישור למטה לאיפוס הסיסמה',
    resetLink: 'איפוס סיסמה',
  },
  resetPassword: {
    title: 'איפוס סיסמה',
    ...
    invalidLink: 'קישור איפוס לא תקף או חסר.',
    requestNew: 'בקש קישור איפוס חדש',
    error: 'אירעה שגיאה. נסה שוב.',
  },
  join: {
    title: 'הצטרפות למשק בית',
    subtitle: 'הוזמנת להצטרף למשק בית משותף',
    prompt: 'לחץ למטה כדי לקבל את ההזמנה ולשתף כספים עם משק הבית.',
    accept: 'קבלת הזמנה',
    joining: 'מצטרף...',
    success: 'הצטרפת ל{name}! מפנה...',
    skip: 'דלג לעת עתה',
    invalidLink: 'קישור הזמנה לא תקף או חסר.',
    loginFirst: 'התחבר כדי להמשיך',
    loginFirstSub: 'עליך להתחבר או ליצור חשבון לפני הצטרפות למשק בית.',
    error: 'אירעה שגיאה. נסה שוב.',
  },
  dashboard: {
    title: 'לוח בקרה',
    ...
    monthlyTrendSub: 'הכנסות מול הוצאות לאורך זמן',
    topMerchants: 'בתי עסק מובילים',
    topMerchantsSub: 'ההוצאה הגבוהה ביותר לפי בית עסק',
    categoryBreakdown: 'פילוח לפי קטגוריה',
    merchantBreakdown: 'פילוח לפי בית עסק',
    merchantBreakdownSub: 'התפלגות ההוצאות לפי בית עסק',
    creditCards: 'כרטיסי אשראי',
    transactions: 'עסקאות',
    categoryTrend: 'מגמות קטגוריה',
    categoryTrendSub: 'קטגוריות מובילות חודש אחר חודש',
  },
  upload: {
    title: 'העלאת עסקאות',
    ...
    tabUpload: 'העלאה',
    tabArchive: 'ארכיון קבצים',
    archiveTitle: 'קבצים שהועלו',
    archiveSub: 'צפייה, הורדה או מחיקה של הקבצים שהועלו',
    archiveEmpty: 'עדיין לא הועלו קבצים',
    archiveFile: 'קובץ',
    archiveDate: 'תאריך העלאה',
    archiveRows: 'שורות',
    archiveSource: 'מקור',
    archiveSize: 'גודל',
    archiveDownload: 'הורדה',
    archiveDelete: 'מחיקה',
    archiveConfirm: 'למחוק את הקובץ ואת כל העסקאות שלו?',
    archiveDeleted: 'הקובץ נמחק בהצלחה',
    archiveNoFile: 'אין קובץ מקורי',
  },
  sources: {
    bank: 'בנק',
    bit: 'ביט',
  ...
  settings: {
    ...
    devInviteNote: 'מצב פיתוח: שתף קישור זה עם המוזמן',
